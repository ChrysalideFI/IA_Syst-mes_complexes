...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\projet\M2 MIASHS\IA_Systemes_complexes\IAComplexe'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\projet\M2 MIASHS\IA_Systemes_complexes\IAComplexe\Scripts\deactivate.nu'
